...
function Navbar() {
    ...
    return (
        <>
            <div className='flex justify-between items-center md:mt-10 p-5 md:mx-25'>
                <div className=''>
                ...
                <div className='hidden md:flex md:gap-10'>
                    ...
                    <div className='group'>
                        <a href="" className='md:text-2xl font-medium' >Skills</a>
                        <div className='relative left-[50%] w-0 h-0.5 bg-black transition-all duration-400 group-hover:w-full from-current group-hover:h-0.5 group-hover:left-0 rounded-4xl'></div>
                    </div>
                    <div className='group'>
                        <a href="" className='md:text-2xl font-medium' >Projects</a>
                        <div className='relative left-[50%] w-0 h-0.5 bg-black transition-all duration-400 group-hover:w-full from-current group-hover:h-0.5 group-hover:left-0 rounded-4xl'></div>
                    </div>
                    <div className='group'>
                        <a href="" className='md:text-2xl font-medium' >Contact</a>
                        <div className='relative left-[50%] w-0 h-0.5 bg-black transition-all duration-400 group-hover:w-full from-current group-hover:h-0.5 group-hover:left-0 rounded-4xl'></div>
                    </div>
